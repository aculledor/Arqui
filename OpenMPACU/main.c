...
int main(int argc, char **argv) {
  ...
  if(argc ==3){
    ...
    f = (int)strtol(argv[2], NULL, 10);
  }else{
    perror("Por favor introduce o numero de Q a empregar sendo 0=2, 1=4, 2=6 e 3=7.");
    perror("Por favor introduce o numero de Fios a empregar sendo 0=1, 1=2, 2=4, 3=6, 4=8.");
    exit(0);
  }
  ...
  struct quaternion *A, *B, *sol, DP;
  
  inicializarQuaternions(&A, &B, &sol, &DP, N, f);

  start_counter();
  
  calculos(A, B, sol, &DP, N, f);
